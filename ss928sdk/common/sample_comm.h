...
#define SAMPLE_FRAME_BUF_RATIO_MIN 80
...
typedef enum {
    ...
    /*  change by edw200  */
    SONY_IMX700_MIPI_8M_30FPS_12BIT,
    SONY_IMX700_MIPI_50M_30FPS_12BIT,
    SONY_IMX700_MIPI_50M_14FPS_10BIT,
    SMART_SC2210_MIPI_3M_30FPS_12BIT,

    SONY_IMX586_MIPI_12M_30FPS_12BIT,
    SONY_IMX586_MIPI_48M_30FPS_12BIT,

    HOST_UVC_30FPS,
    TWO_SCREEN_30FPS,

    SONY_IMX700_MIPI_2M_30FPS_10BIT,
    SONY_IMX700_MIPI_2M_60FPS_10BIT,

    SONY_IMX586_MIPI_8M_30FPS_12BIT,
    SONY_IMX586_MIPI_34M_30FPS_12BIT,
    // change end
    SNS_TYPE_BUTT,
} sample_sns_type;
...
td_s32 sample_comm_sys_set_gps_info(ot_gps_info *info);
...
td_s32 sample_comm_vo_bind_vpss(ot_vo_layer src_vo_layer, ot_vo_chn src_vo_chn,
                              ot_vpss_grp vpss_grp);
td_s32 sample_comm_vo_un_bind_venc(ot_vo_layer src_vo_layer, ot_vo_chn src_vo_chn,
                              ot_vpss_grp vpss_grp);
...
td_void sample_comm_venc_set_save_jpg(ot_venc_chn venc_chn);
...
td_s32 sample_comm_venc_stream_callback(void(*func)(td_s32, td_s32, ot_venc_stream*));
td_s32 sample_comm_venc_photo_snap_start(ot_venc_chn venc_chn, ot_size *size, td_bool support_dcf);
...
td_s32 sample_comm_region_updata_canvas(ot_rgn_handle handle, td_char *bmp_data);
...
td_s32 sample_comm_venc_set_rc_param(ot_venc_chn venc_chn, td_s32 value);
td_s32 sample_comm_venc_set_intra_refresh(ot_venc_chn venc_chn, ot_venc_intra_refresh_mode intra_refresh_mode);
