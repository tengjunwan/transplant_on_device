...
static ext_data_type_t g_mipi_ext_data_type_imx700_12bit_8m_nowdr_attr = {
    .devno = 0,
    .num = MIPI_NUM,
    .ext_data_bit_width = {12, 12, 12},
    .ext_data_type = {0x37, 0x2c, 0x2c}
...
static combo_dev_attr_t g_mipi_4lane_chn0_sensor_sc2210_12bit_3m_nowdr_attr = {
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
...
static combo_dev_attr_t g_mipi_4lane_chn2_sensor_sc2210_12bit_3m_nowdr_attr = {
    .devno = 2,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, 1920, 1080},
...
// #if 0
static combo_dev_attr_t g_mipi_4lane_chn0_sensor_imx586_12bit_34m_nowdr_attr = {
    .devno = 0, 
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, 7680, 4320},
    .mipi_attr  = {
        DATA_TYPE_RAW_10BIT,
        OT_MIPI_WDR_MODE_NONE,
        {0, 1, 2, 3, -1, -1, -1, -1}
...
// #if 0
static combo_dev_attr_t g_mipi_4lane_chn0_sensor_imx586_12bit_8m_nowdr_attr = {
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
...
static combo_dev_attr_t g_mipi_4lane_chn0_sensor_imx586_12bit_12m_nowdr_attr = {
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
...
static combo_dev_attr_t g_mipi_4lane_chn2_sensor_imx586_12bit_34m_nowdr_attr = {
    .devno = 2, /* dev 2 */
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, 7680, 4320},
...
static combo_dev_attr_t g_mipi_4lane_chn2_sensor_imx586_12bit_48m_nowdr_attr = {
    .devno = 2, /* dev 2 */
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, 8000, 6000},
...
static combo_dev_attr_t g_mipi_4lane_chn2_sensor_imx586_12bit_8m_nowdr_attr = {
    .devno = 2, /* dev 2 */
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, 3840, 2160},
...
static combo_dev_attr_t g_mipi_4lane_chn2_sensor_imx586_12bit_12m_nowdr_attr = {
    .devno = 2, /* dev 2 */
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, 4000, 3000},
...
static combo_dev_attr_t g_mipi_4lane_chn2_sensor_imx700_10bit_2m_nowdr_attr = {
    .devno = 2,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, 1920, 1084},
    .mipi_attr  = {
        DATA_TYPE_RAW_10BIT,
        OT_MIPI_WDR_MODE_NONE,
        {4, 5, 6, 7, -1, -1, -1, -1}
...
static combo_dev_attr_t g_mipi_4lane_chn0_sensor_imx700_10bit_2m_nowdr_attr = {
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, 1920, 1084},
...
static combo_dev_attr_t g_mipi_4lane_chn0_sensor_imx700_12bit_8m_nowdr_attr = {
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, 3840, 2160},
...
static combo_dev_attr_t g_mipi_4lane_chn2_sensor_imx700_12bit_8m_nowdr_attr = {
    .devno = 2,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, 3840, 2160},
...
static combo_dev_attr_t g_mipi_4lane_chn0_sensor_imx700_12bit_50m_nowdr_attr = {
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, 8192, 6144},
    .mipi_attr  = {
        DATA_TYPE_RAW_12BIT,
        OT_MIPI_WDR_MODE_NONE,
        {0, 1, 2, 3, -1, -1, -1, -1}
...
static combo_dev_attr_t g_mipi_4lane_chn0_sensor_imx700_10bit_50m_nowdr_attr = {
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X2,
    .img_rect   = {0, 0, 8192, 6144},
...
static combo_dev_attr_t g_mipi_4lane_chn2_sensor_imx700_12bit_50m_nowdr_attr = {
    .devno = 2,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, 8192, 6144},
...
static td_void sample_comm_vi_get_mipi_attr(sample_sns_type sns_type, combo_dev_attr_t *combo_attr)
{
    ...
    switch (sns_type) {
        ...
        case SMART_SC2210_MIPI_3M_30FPS_12BIT:
            ob_height = OB_HEIGHT_END;
            (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_4lane_chn0_sensor_sc2210_12bit_3m_nowdr_attr, sizeof(combo_dev_attr_t));
                break;
    
        case SONY_IMX586_MIPI_8M_30FPS_12BIT:
            ob_height = OB_HEIGHT_END;
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_4lane_chn0_sensor_imx586_12bit_8m_nowdr_attr, sizeof(combo_dev_attr_t));
                break;

        case SONY_IMX586_MIPI_12M_30FPS_12BIT:
            ob_height = OB_HEIGHT_END;
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_4lane_chn0_sensor_imx586_12bit_12m_nowdr_attr, sizeof(combo_dev_attr_t));
                break;

        case SONY_IMX586_MIPI_34M_30FPS_12BIT:
            ob_height = OB_HEIGHT_END;
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_4lane_chn0_sensor_imx586_12bit_34m_nowdr_attr, sizeof(combo_dev_attr_t));
            break;  
        ...
        case SONY_IMX700_MIPI_2M_60FPS_10BIT:
            ob_height = OB_HEIGHT_END;
            (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                &g_mipi_4lane_chn0_sensor_imx700_10bit_2m_nowdr_attr, sizeof(combo_dev_attr_t));
            break;      
        case SONY_IMX700_MIPI_8M_30FPS_12BIT:
            ob_height = OB_HEIGHT_END;
            (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                &g_mipi_4lane_chn0_sensor_imx700_12bit_8m_nowdr_attr, sizeof(combo_dev_attr_t));
            break;
        case SONY_IMX700_MIPI_50M_30FPS_12BIT:
            ob_height = OB_HEIGHT_END;
            (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                &g_mipi_4lane_chn0_sensor_imx700_12bit_50m_nowdr_attr, sizeof(combo_dev_attr_t));
            break;

        case SONY_IMX700_MIPI_50M_14FPS_10BIT:
            ob_height = OB_HEIGHT_END;
            (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                &g_mipi_4lane_chn0_sensor_imx700_10bit_50m_nowdr_attr, sizeof(combo_dev_attr_t));
            break;
...
static td_void sample_comm_vi_get_mipi_ext_data_attr(sample_sns_type sns_type, ext_data_type_t *ext_data_attr)
{
    switch (sns_type) {
        ...
        case SONY_IMX700_MIPI_50M_14FPS_10BIT:  
            (td_void)memcpy_s(ext_data_attr, sizeof(ext_data_type_t),
                &g_mipi_ext_data_type_imx700_12bit_8m_nowdr_attr, sizeof(ext_data_type_t));
            break;
                                                      ...
                                                      combo_dev_attr_t *combo_attr)
{
    ...
    case SMART_SC2210_MIPI_3M_30FPS_12BIT:
        ob_height = OB_HEIGHT_END;
            if (vi_dev == 0) {
                ...
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_4lane_chn2_sensor_sc2210_12bit_3m_nowdr_attr, sizeof(combo_dev_attr_t));
            }
            break;
    ...
    case SONY_IMX586_MIPI_8M_30FPS_12BIT:
            ...
            if (vi_dev == 0) {
                ...
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_4lane_chn2_sensor_imx586_12bit_8m_nowdr_attr, sizeof(combo_dev_attr_t));
            }
            break;
    ...
    case SONY_IMX586_MIPI_12M_30FPS_12BIT:
            ...
            if (vi_dev == 0) {
                ...
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_4lane_chn2_sensor_imx586_12bit_12m_nowdr_attr, sizeof(combo_dev_attr_t));
            }
            break;
    ...
    case SONY_IMX586_MIPI_34M_30FPS_12BIT:
            ...
            if (vi_dev == 0) {
                ...
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_4lane_chn2_sensor_imx586_12bit_34m_nowdr_attr, sizeof(combo_dev_attr_t));
            }
            break;
    ...
    case SONY_IMX586_MIPI_48M_30FPS_12BIT:
            ...
            if (vi_dev == 0) {
                ...
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_4lane_chn2_sensor_imx586_12bit_48m_nowdr_attr, sizeof(combo_dev_attr_t));
            }
            break;
    ...
    case SONY_IMX700_MIPI_2M_60FPS_10BIT:
            ...
            if (vi_dev == 0) {
                ...
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_4lane_chn2_sensor_imx700_10bit_2m_nowdr_attr, sizeof(combo_dev_attr_t));
            }
            break;  
    case SONY_IMX700_MIPI_8M_30FPS_12BIT:
            ob_height = OB_HEIGHT_END;
            if (vi_dev == 0) {
                ...
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_4lane_chn2_sensor_imx700_12bit_8m_nowdr_attr, sizeof(combo_dev_attr_t));
            }
            break;
    ...
    case SONY_IMX700_MIPI_50M_30FPS_12BIT:
            ...
            if (vi_dev == 0) {
                ...
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_4lane_chn2_sensor_imx700_12bit_50m_nowdr_attr, sizeof(combo_dev_attr_t));
            }
            break;
...
td_void sample_comm_vi_get_default_mipi_info(sample_sns_type sns_type, sample_mipi_info *mipi_info)
{
    ...
    mipi_info->divide_mode = LANE_DIVIDE_MODE_1; // LANE_DIVIDE_MODE_0 change by geoai
...
td_void sample_comm_vi_get_default_dev_info(sample_sns_type sns_type, sample_vi_dev_info *dev_info)
{
    ...
    if (sns_type == SONY_IMX700_MIPI_50M_30FPS_12BIT || sns_type == SONY_IMX700_MIPI_50M_14FPS_10BIT) {
        dev_info->dev_attr.data_rate = OT_DATA_RATE_X2;
    }
                                             ...
                                             sample_vi_pipe_info pipe_info[])
{
    ...
    for (i = 0; i < bind_pipe->pipe_num; i++) {
        ...
        if (sns_type == SONY_IMX586_MIPI_8M_30FPS_12BIT || sns_type == SONY_IMX586_MIPI_12M_30FPS_12BIT || sns_type == SONY_IMX586_MIPI_34M_30FPS_12BIT || sns_type == SONY_IMX586_MIPI_48M_30FPS_12BIT) {
            pipe_info[i].pipe_attr.compress_mode                  = OT_COMPRESS_MODE_NONE;
        }

        if (sns_type == SONY_IMX700_MIPI_8M_30FPS_12BIT || sns_type == SONY_IMX700_MIPI_50M_30FPS_12BIT 
                                            || sns_type == SONY_IMX700_MIPI_50M_14FPS_10BIT 
                                            || sns_type == SONY_IMX700_MIPI_2M_30FPS_10BIT 
                                            || sns_type == SONY_IMX700_MIPI_2M_60FPS_10BIT) {
            pipe_info[i].pipe_attr.pixel_format  = OT_PIXEL_FORMAT_RGB_BAYER_10BPP;                                    
            pipe_info[i].pipe_attr.compress_mode                  = OT_COMPRESS_MODE_NONE;
        }
    ...
    sample_vi_pipe_info pipe_info[])
{
    ...
    for (i = 0; i < bind_pipe->pipe_num; i++) {
        ...
        if (sns_type == SONY_IMX700_MIPI_8M_30FPS_12BIT || sns_type == SONY_IMX700_MIPI_50M_30FPS_12BIT || 
            sns_type == SONY_IMX700_MIPI_2M_30FPS_10BIT || sns_type == SONY_IMX700_MIPI_2M_60FPS_10BIT) {
            pipe_info[i].pipe_attr.compress_mode = OT_COMPRESS_MODE_NONE;
        }

        if (sns_type == SONY_IMX700_MIPI_50M_14FPS_10BIT) {
            pipe_info[i].pipe_attr.pixel_format  = OT_PIXEL_FORMAT_RGB_BAYER_10BPP;
            // pipe_info[i].pipe_attr.compress_mode = OT_COMPRESS_MODE_NONE;
        }
...
static td_s32 sample_comm_vi_start_one_pipe(ot_vi_pipe vi_pipe, const sample_vi_pipe_info *pipe_info)
{
    ...
    // printf("pipe_info->pipe_attr.size.width %d\n",pipe_info->pipe_attr.size.width);
    // printf("pipe_info->pipe_attr.size.height %d\n",pipe_info->pipe_attr.size.height);
...
static td_s32 sample_comm_vi_start_one_pipe_isp(ot_vi_pipe vi_pipe, td_u8 pipe_index, const sample_vi_cfg *vi_cfg)
{
    ...
    if (ret != TD_SUCCESS) {
        printf("ss_mpi_isp_get_ctrl_param %d failed\n", vi_pipe);
        return TD_FAILURE;
    }
    isp_ctrl_param.be_buf_num = 18;
    ret = ss_mpi_isp_set_ctrl_param(vi_pipe, &isp_ctrl_param);
    if (ret != TD_SUCCESS) {
        printf("ss_mpi_isp_set_ctrl_param %d failed\n", vi_pipe);
        return TD_FAILURE;
    }
